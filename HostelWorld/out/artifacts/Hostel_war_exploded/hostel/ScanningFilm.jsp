...
<head>
  ...
  <body style="background-color:rgba(54, 105, 55, 0.75)">
   <jsp:useBean id="filmList" type="hostel_world.model.list.FilmList" scope="session"></jsp:useBean>
  <jsp:useBean id="film" class="hostel_world.model.Film" scope="page"></jsp:useBean>
	...
	<div class="row">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="col-xs-9">
				<ul>
					<li class="list-group-item">店名：<jsp:getProperty name="film" property="title"/></li>
					<li class="list-group-item">地址：<jsp:getProperty name="film" property="director"/></li>
					<li class="list-group-item">评分：<jsp:getProperty name="film" property="duration"/></li>
					<li class="list-group-item">简介：<jsp:getProperty name="film" property="language"/></li>
				</ul>
				<br/>
