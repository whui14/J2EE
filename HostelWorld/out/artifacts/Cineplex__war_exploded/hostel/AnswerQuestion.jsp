...
<!--body-->
  ...
  <jsp:useBean id="questionList" type="hostel_world.model.list.QuestionList" scope="session"></jsp:useBean>
  <jsp:useBean id="question" class="hostel_world.model.Question" scope="page"></jsp:useBean>
