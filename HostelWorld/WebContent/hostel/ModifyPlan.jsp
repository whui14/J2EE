...
<head>
  ...
  <jsp:useBean id="planList" type="hostel_world.model.list.PlanList" scope="session"></jsp:useBean>
  <jsp:useBean id="plan" class="hostel_world.model.Plan" scope="page"></jsp:useBean>
